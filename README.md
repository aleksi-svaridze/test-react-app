# Task - Create minimun 3 components for testing
...
## Solution
     ...
     - Created form component and tested its input, label and inputValue function for render - (CounterForm.js: CounterForm.test.js)
